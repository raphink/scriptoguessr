// Data source: https://deanebarker.net/other/bible/
...
const BIBLE_DATA = {
  ...
  Deuteronomy: {
    chapters: 34,
    versesPerChapter: [
      22, 25, 29, 49, 33, 25, 26, 20, 29, 22, 32, 32, 18, 29, 23, 22, 20, 22,
  ...
  Psalms: {
    ...
    versesPerChapter: [
      ...
      22, 13, 11, 17, 20, 23, 19, 9, 6, 7, 23, 13, 11, 11, 17, 12, 8, 12, 11,
      10, 13, 20, 7, 35, 36, 5, 24, 20, 28, 23, 10, 12, 20, 72, 13, 19, 16, 8,
      18, 12, 13, 17, 7, 18, 52, 17, 16, 15, 5, 23, 11, 13, 12, 9, 9, 5, 8, 28,
      22, 35, 45, 48, 43, 13, 31, 7, 10, 10, 9, 8, 18, 19, 2, 29, 176, 7, 8, 9,
      4, 8, 5, 6, 5, 6, 8, 8, 3, 18, 3, 3, 21, 26, 9, 8, 24, 14, 10, 8, 12, 15,
      21, 10, 20, 14, 9, 6,
    ],
    percentage: 4.93,
  },
  ...
  Jeremiah: {
    ...
    versesPerChapter: [
      ...
      21, 28, 18, 16, 18, 22, 13, 30, 40, 23, 14, 30, 22, 44, 13, 30, 5,
    ],
    percentage: 5.4,
  },
  Lamentations: {
  ...
  Ezekiel: {
    ...
    versesPerChapter: [
      ...
      49, 32, 31, 49, 27, 17, 21, 36, 26, 21, 26, 6, 19, 32, 33, 31, 15, 38, 28,
      23, 29, 49, 26, 20, 27, 31, 25, 24, 23,
    ],
    percentage: 4.89,
  },
  Daniel: {
  ...
  '2 Corinthians': {
    chapters: 13,
    versesPerChapter: [18, 17, 18, 18, 21, 18, 16, 24, 15, 18, 33, 21, 14],
    percentage: 0.73,
  },
  Galatians: {
    chapters: 6,
